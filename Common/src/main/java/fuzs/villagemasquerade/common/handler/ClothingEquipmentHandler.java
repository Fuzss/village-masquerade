package fuzs.villagemasquerade.common.handler;
...
public class ClothingEquipmentHandler {
    private static final List<EquipmentSlot> CLOTHING_EQUIPMENT_SLOTS = ImmutableList.of(EquipmentSlot.HEAD,
            EquipmentSlot.CHEST,
            EquipmentSlot.LEGS);
    private static final TargetingConditions.Selector ENEMY_SELECTOR = (LivingEntity livingEntity, ServerLevel serverLevel) -> {
