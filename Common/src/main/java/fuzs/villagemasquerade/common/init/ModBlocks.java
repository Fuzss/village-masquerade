...
import fuzs.villagemasquerade.common.world.level.block.VillagerSkullBlock;
import fuzs.villagemasquerade.common.world.level.block.VillagerWallSkullBlock;
...
public class ModBlocks {
    public static final Holder.Reference<Block> VILLAGER_HEAD_BLOCK = ModRegistry.REGISTRIES.registerBlock(
            "villager_head",
    ...
    public static final Holder.Reference<Block> VILLAGER_WALL_HEAD_BLOCK = ModRegistry.REGISTRIES.registerBlock(
            "villager_wall_head",
            ...
            () -> Blocks.wallVariant(VILLAGER_HEAD_BLOCK.value(), true)
                    .strength(1.0F)
                    .pushReaction(PushReaction.DESTROY));
    public static final Holder.Reference<Block> IRON_GOLEM_HEAD_BLOCK = ModRegistry.REGISTRIES.registerBlock(
            "iron_golem_head",
    ...
    public static final Holder.Reference<Block> ILLAGER_HEAD_BLOCK = ModRegistry.REGISTRIES.registerBlock("illager_head",
            ...
            () -> BlockBehaviour.Properties.of()
                    ...
                    .strength(1.0F)
                    .pushReaction(PushReaction.DESTROY));
    public static final Holder.Reference<Block> ILLAGER_WALL_HEAD_BLOCK = ModRegistry.REGISTRIES.registerBlock(
            "illager_wall_head",
    ...
    public static void onAddBlockEntityTypeBlocks(BiConsumer<BlockEntityType<?>, Block> consumer) {
        consumer.accept(BlockEntityTypes.SKULL, VILLAGER_HEAD_BLOCK.value());
        consumer.accept(BlockEntityTypes.SKULL, VILLAGER_WALL_HEAD_BLOCK.value());
        consumer.accept(BlockEntityTypes.SKULL, IRON_GOLEM_HEAD_BLOCK.value());
        consumer.accept(BlockEntityTypes.SKULL, IRON_GOLEM_WALL_HEAD_BLOCK.value());
        consumer.accept(BlockEntityTypes.SKULL, ILLAGER_HEAD_BLOCK.value());
        consumer.accept(BlockEntityTypes.SKULL, ILLAGER_WALL_HEAD_BLOCK.value());
    }
}
